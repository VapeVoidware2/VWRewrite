    ...
    ["Bedwars"] = {
        vapeGithubRequest = function(scripturl)
            if not isfile("vape/"..scripturl) then
                local suc, res = pcall(function() return game:HttpGet("https://raw.githubusercontent.com/VapeVoidware2/vapevoidware/main/"..scripturl, true) end)
                assert(suc, res)
...
VWFunctions.fetchCheatEngineSupportFile = function(fileName)
    local url = "https://raw.githubusercontent.com/VapeVoidware2/VWCE/main/CheatEngine/"..tostring(fileName)
    local suc, res = pcall(function()
